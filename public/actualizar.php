...
if(isset($_POST['actualizar'])){
    ...
    //actualizar coche
    $q="update coches set id=?, marca=?, modelo=?, color=?, kilometros=? where id=?";
    ...
    mysqli_close($llave);
    $_SESSION['mensaje']="Coche actualizado con éxito";
...
<body style="background-color:black">
    <h5 class="text-center mt-2">Actualizar coche</h5>
    <div class="container">
        <form name="aw" action="actualizar.php" method="POST" class="text-light">
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-secondary btn-lg btn-block" name="actualizar">Actualizar</button>
                </button>
            </div>
